...
import os
# Standard library imports for file operations, system interaction, and utilities
import shutil  # File and directory operations (copy, move, remove)
import sys  # System-specific parameters and functions
import warnings  # Warning control and filtering
from copy import deepcopy  # Deep copying of objects
from datetime import datetime  # Date and time handling
from time import time, sleep  # Time measurement and delays
from typing import Tuple, Union, List  # Type hints for better code documentation

# Core scientific computing libraries
import numpy as np  # Numerical computing with arrays
import torch  # PyTorch deep learning framework

# BatchGenerators v1 imports for data loading and augmentation
from batchgenerators.dataloading.multi_threaded_augmenter import MultiThreadedAugmenter  # Multi-threaded data augmentation
from batchgenerators.dataloading.nondet_multi_threaded_augmenter import NonDetMultiThreadedAugmenter  # Non-deterministic multi-threaded augmentation
from batchgenerators.dataloading.single_threaded_augmenter import SingleThreadedAugmenter  # Single-threaded data augmentation
from batchgenerators.utilities.file_and_folder_operations import join, load_json, isfile, save_json, maybe_mkdir_p  # File system utilities

# BatchGenerators v2 imports for advanced data augmentation transforms
from batchgeneratorsv2.helpers.scalar_type import RandomScalar  # Random scalar value generation
from batchgeneratorsv2.transforms.base.basic_transform import BasicTransform  # Base class for all transforms
from batchgeneratorsv2.transforms.intensity.brightness import MultiplicativeBrightnessTransform  # Brightness adjustment transform
from batchgeneratorsv2.transforms.intensity.contrast import ContrastTransform, BGContrast  # Contrast adjustment transforms
from batchgeneratorsv2.transforms.intensity.gamma import GammaTransform  # Gamma correction transform
from batchgeneratorsv2.transforms.intensity.gaussian_noise import GaussianNoiseTransform  # Gaussian noise addition
from batchgeneratorsv2.transforms.nnunet.random_binary_operator import ApplyRandomBinaryOperatorTransform  # Random binary operations on nnUNet data
from batchgeneratorsv2.transforms.nnunet.remove_connected_components import \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform  # Remove random connected components from segmentation
from batchgeneratorsv2.transforms.nnunet.seg_to_onehot import MoveSegAsOneHotToDataTransform  # Convert segmentation to one-hot encoding
from batchgeneratorsv2.transforms.noise.gaussian_blur import GaussianBlurTransform  # Gaussian blur for regularization
from batchgeneratorsv2.transforms.spatial.low_resolution import SimulateLowResolutionTransform  # Simulate low-resolution artifacts
from batchgeneratorsv2.transforms.spatial.mirroring import MirrorTransform  # Data mirroring/augmentation
from batchgeneratorsv2.transforms.spatial.spatial import SpatialTransform  # Spatial transformations (rotation, scaling, etc.)
from batchgeneratorsv2.transforms.utils.compose import ComposeTransforms  # Compose multiple transforms together
from batchgeneratorsv2.transforms.utils.deep_supervision_downsampling import DownsampleSegForDSTransform  # Downsampling for deep supervision
from batchgeneratorsv2.transforms.utils.nnunet_masking import MaskImageTransform  # Image masking utilities
from batchgeneratorsv2.transforms.utils.pseudo2d import Convert3DTo2DTransform, Convert2DTo3DTransform  # 2D/3D conversion for pseudo-2D training
from batchgeneratorsv2.transforms.utils.random import RandomTransform  # Base class for random transforms
from batchgeneratorsv2.transforms.utils.remove_label import RemoveLabelTansform  # Remove specific labels from data
from batchgeneratorsv2.transforms.utils.seg_to_regions import ConvertSegmentationToRegionsTransform  # Convert segmentation to regions
